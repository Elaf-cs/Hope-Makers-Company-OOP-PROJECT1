...
public class CV {
    ...
    private int verificationCode;  //هذا الشفرة انو ارسلت الفلوس لحسابنا
    static int counterApp = 0;    //يحسب عدد الموظفين
    private String universityMajor; // قسمك في الجامعة وش؟
    private String courseName;  // وش الكورس اللي اخذته
    static String skills = null ; // اعطيني مهارات تتقنها 
    private int yearsOfExperience; // عدد سنوات خبرتك
